...
- [ ] Apollo Client에 인증 헤더 추가 (setContext)
- [ ] JWT 토큰 저장소 구현 (localStorage/sessionStorage)
- [ ] 로그인 페이지 구현
- [ ] 로그인 폼 컴포넌트
- [ ] 토큰 만료 처리 및 자동 갱신 로직
- [ ] 인증 상태 관리 (Context API 또는 상태 관리 라이브러리)
- [ ] 로그아웃 기능
- [ ] 인증이 필요한 페이지 라우트 가드 구현
- [ ] 401 에러 처리 및 자동 로그아웃
...
- [ ] 일별 근태 리포트 페이지
  ...
  - 리포트 카드 컴포넌트 (출근률, 지각 수, 결근 수, 근무 시간 등)
  - 날짜 선택 컴포넌트
  - 직원별 통계 테이블 컴포넌트
- [ ] 주별 근태 리포트 페이지
...
- [ ] Attendance Service GraphQL 쿼리 정의
  - Employee 관련 쿼리/뮤테이션
  - Attendance 관련 쿼리/뮤테이션
  - Report 관련 쿼리
- [ ] Inventory Service GraphQL 쿼리 정의
  - Purchase Order 관련 쿼리/뮤테이션
  - Inventory 관련 쿼리/뮤테이션
- [ ] Sales Service GraphQL 쿼리 정의
  - Sales 리포트 관련 쿼리
  - Order 관련 쿼리/뮤테이션
